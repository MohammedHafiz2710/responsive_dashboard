...
import 'package:responsive_dashboard/Features/homepage/presentation/views/widgets/my_card_and_transaction_section.dart';
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Expanded(
          flex: 2,
          child: Padding(padding: const EdgeInsets.symmetric(vertical: 20), child: MyCardAndTransactionSections()),
        ),
      ],
    );
  }
